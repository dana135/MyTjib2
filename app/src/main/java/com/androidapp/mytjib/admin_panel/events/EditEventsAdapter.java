...
public class EditEventsAdapter extends RecyclerView.Adapter<EditEventsAdapter.ViewHolder> {

    private final Context context;
    private final ClickListener listener;
    private List<Event> events;

    public EditEventsAdapter(Context context, ClickListener listener) {
