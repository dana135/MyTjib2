...
public class OnlineConcertsFragment  extends Fragment {
    ...
    public static OnlineConcertsFragment newInstance() {
        return new OnlineConcertsFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getOnlineConcerts().observe(getViewLifecycleOwner(), new Observer<List<Event>>() {
            @Override
